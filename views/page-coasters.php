...
?>
    ...
    <section class="border-t-2 border-(--darkened-eggshell) my-10 py-5 flex flex-col md:grid md:grid-cols-3 gap-8">
        ...
        <div id="pagination" class="col-start-2 col-span-2 flex gap-4 justify-center my-6">
            <form mix-get="/api-pagination-coasters?offset=<?php _(max(0, $offset - 6)) ?>"><button class="btn-secondary">Prev.</button></form>
            <form mix-get="/api-pagination-coasters?offset=<?php _($offset + 6) ?>"><button class="btn-secondary">Next</button></form>
        </div>
